...
export const PATCH_SUCCEEDED = 0
export const PATCH_FAILED = 1

export const RELEASE_METHOD_PROMOTE = 'Promote'
export const RELEASE_METHOD_UPLOAD = 'Upload'
export const RELEASE_METHOD_ROLLBACK = 'Rollback'

export const DIFF_MANIFEST_FILE_NAME = 'hotcodepush.json'

export const DIFF_FILE_NAME = 'diff'

export const IS_BASE_BUNDLE_YES = 1
export const IS_BASE_BUNDLE_NO = 0
