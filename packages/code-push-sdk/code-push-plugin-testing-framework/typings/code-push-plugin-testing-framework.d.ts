...
declare module 'code-push-plugin-testing-framework/script/projectManager' {
   ...
   */
  export function setupUpdateScenario(
    projectManager: ProjectManager,
    targetPlatform: platform.IPlatform,
    scenarioJsPath: string,
    version: string,
...
declare module 'code-push-plugin-testing-framework/script/serverUtil' {
   ...
   */
  export function expectTestMessages(
    expectedMessages: (string | AppMessage)[],
  ): Q.Promise<void>
  /**
...
declare module 'code-push-plugin-testing-framework/script/testUtil' {
  ...
  export class TestUtil {
     ...
     */
    static readMochaCommandLineOption(
      optionName: string,
      defaultValue?: string,
    ): string
    /**
...
declare module 'code-push-plugin-testing-framework/script/index' {
  ...
  import {
    ...
    setupUpdateScenario,
  } from 'code-push-plugin-testing-framework/script/projectManager'
