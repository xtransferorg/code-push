...
public class FileUtils {
    ...
    public static File copyFileToDirectory(String sourceFilePath, String destinationDirectoryPath) throws IOException {
        File sourceFile = new File(sourceFilePath);
        File destDir = new File(destinationDirectoryPath);
        if (!destDir.exists()) {
            destDir.mkdir();
        }
        String destFilePath = CodePushUtils.appendPathComponent(destinationDirectoryPath, sourceFile.getName());
    ...
    public static File copyAssetToFolder(Context context, String cacheFile, String assetFileName) {
        try {
            File targetDir = new File(cacheFile);
            ...
            Log.e("AssetCopy", "文件复制失败: " + e.getMessage());
        }
        return null;
    }
