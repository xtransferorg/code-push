...
public class SettingsManager {
    ...
    public SettingsManager(Context applicationContext,String deploymentKey) {
        mSettings = applicationContext.getSharedPreferences(deploymentKey+CodePushConstants.CODE_PUSH_PREFERENCES, 0);
    }
    ...
    public boolean isPendingHash(String packageHash) {
        JSONObject pendingUpdate = getPendingUpdate();
