...
public class CodePushConstants {
    ...
    public static final String CODE_PUSH_HASH_FILE_NAME = "codepush.json";
    public static final String CODE_PUSH_OLD_HASH_FILE_NAME = "CodePushHash.json";
    public static final String CODE_PUSH_FOLDER = "release_android";
    ...
    public static final String CODE_PUSH_PATCH_STATUS_NAME = "CodePushPatchStatus";
    public static final String CODE_PUSH_PATCH_STATUS_ERROR = "PATCH_ERROR";
    public static final String CODE_PUSH_PATCH_DONE = "PATCH_DONE";
    public static final String CODE_PUSH_PATCH_START = "PATCH_START";


    public static final String DOWNLOAD_URL_KEY = "downloadUrl";
    public static final String BASE_DOWNLOAD_URL_KEY = "baseDownloadUrl";

    public static final String CURRENT_PACKAGE_DIFF_KEY = "currentPackageDiff";
    public static final String DOWNLOAD_DIFF_URL_KEY = "downloadDiffUrl";
    public static final String DIFF_AVAILABLE = "isDiffAvailable";
    public static final String DOWNLOAD_DIFF_SIZE_KEY = "downloadDiffSize";

    public static final String DIFF_FILE_NAME = "codePushDiff";
    public static final String BASE_FILE_NAME = "BasePackage";
    ...
    public static final String BASE_PACKAGE_KEY = "basePackageHash";
    ...
    public static final String REACT_NATIVE_LOG_TAG = "ReactNativeCodePush";
    public static final String RELATIVE_BUNDLE_PATH_KEY = "bundlePath";
    public static final String RELATIVE_BUNDLE_PATH_FAILED = "patchFailed";
    ...
    public static final String CODE_PUSH_COMMON_HASH = "CODE_PUSH_COMMON_HASH";
    ...
    public static final String BASE_PACKAGE_SIZE_KEY = "basePackageSize";
    public static final String PACKAGE_SIZE_KEY = "packageSize";

    public static final String PACKAGE_LOCAL_CACHE_HINT = "localCacheHint";
}
