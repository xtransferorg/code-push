...
export interface Configuration {
  ...
  /**
   * The hash value of the current package.
   */
  packageHash: string
...
declare namespace CodePush {
  ...
  function getConfiguration(): Promise<Configuration>

  function getCurrentPackage(): Promise<LocalPackage | null>
